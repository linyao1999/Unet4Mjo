...
num_epochs = 12   # how many loops we want to train the model. 
trainN = 345*4
M = 365*4  
...
path_forecasts = '/global/homes/l/linyaoly/ERA5/script/Stability-Explanability/7maps_36yrtraining_RMMERA5_filtered_6hr/output/'
...
for testyn in np.arange(testystat,testyend):
        ...
        np.savetxt(path_forecasts+'predicted_UNET_7maps_RMMERA5_36yr_lead'+str(leadmjo)+'_6hrnput_mem'+str(nmem)+'_'+str(testyn)+'.csv', autoreg_pred, delimiter=",")
        np.savetxt(path_forecasts+'truth_UNET_7maps_RMMERA5_36yr_lead'+str(leadmjo)+'_6hrinput_mem'+str(nmem)+'_'+str(testyn)+'.csv', autoreg_true, delimiter=",")
