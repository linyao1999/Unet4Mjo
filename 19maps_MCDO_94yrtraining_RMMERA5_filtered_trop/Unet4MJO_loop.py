...
Fn1 = datadir+'ERA5.u200GfltG.day.'+str(ysta)+'to2022.nc'
Fn2 = datadir+'ERA5.u850GfltG.day.'+str(ysta)+'to2022.nc'
Fn3 = datadir+'ERA5.olrGfltG.day.'+str(ysta)+'to2022.nc'

Fn4 = datadir+'ERA5.tcwvGfltG.day.'+str(ysta)+'to2022.nc'
Fn5 = datadir+'ERA5.v200GfltG.day.'+str(ysta)+'to2022.nc'
Fn6 = datadir+'ERA5.T200GfltG.day.'+str(ysta)+'to2022.nc'
Fn7 = datadir+'ERA5.prepGfltG.day.'+str(ysta)+'to2022.nc'

Fn8 = datadir+'ERA5.u500GfltG.day.'+str(ysta)+'to2022.nc'
Fn9 = datadir+'ERA5.v500GfltG.day.'+str(ysta)+'to2022.nc'
Fn10 = datadir+'ERA5.v850GfltG.day.'+str(ysta)+'to2022.nc'
Fn11 = datadir+'ERA5.Z200GfltG.day.'+str(ysta)+'to2022.nc'
Fn12 = datadir+'ERA5.Z500GfltG.day.'+str(ysta)+'to2022.nc'
Fn13 = datadir+'ERA5.Z850GfltG.day.'+str(ysta)+'to2022.nc'
Fn14 = datadir+'ERA5.T500GfltG.day.'+str(ysta)+'to2022.nc'
Fn15 = datadir+'ERA5.T850GfltG.day.'+str(ysta)+'to2022.nc'
Fn16 = datadir+'ERA5.q200GfltG.day.'+str(ysta)+'to2022.nc'
Fn17 = datadir+'ERA5.q500GfltG.day.'+str(ysta)+'to2022.nc'
Fn18 = datadir+'ERA5.q850GfltG.day.'+str(ysta)+'to2022.nc'

# always be careful to let sst as the last input variable
Fn19 = datadir+'ERA5.sstGfltGmask0.day.'+str(ysta)+'to2022.nc'
...
Fnmjo = '/global/homes/l/linyaoly/ERA5/reanalysis/RMM_ERA5_daily_'+str(ysta)+'.nc'
### PATHS and FLAGS ###
...
model_save = '/pscratch/sd/l/linyaoly/Unet4MJO/19variables_MCDO_94yr_filtered_'+runflg+'/'
...
net = net.eval()
torch.save(net.state_dict(), model_save+'predicted_MCDO_UNET_'+str(len(vn))+'maps'+runflg+'_RMMERA5_94yr_lead'+str(leadmjo)+'_dailyinput.pt')
...
for testyn in np.arange(testystat,testyend):
        ...
        np.savetxt(path_forecasts+'predicted_MCDO_UNET_'+str(len(vn))+'maps'+runflg+'_RMMERA5_94yr_lead'+str(leadmjo)+'_dailyinput_mem'+str(nmem)+'d'+str(testyn)+'.csv', autoreg_pred, delimiter=",")
        np.savetxt(path_forecasts+'truth_MCDO_UNET_'+str(len(vn))+'maps'+runflg+'_RMMERA5_94yr_lead'+str(leadmjo)+'_dailyinput_mem'+str(nmem)+'d'+str(testyn)+'.csv', autoreg_true, delimiter=",")
        # np.savetxt(path_forecasts+'predicted_disav_MCDO_UNET_'+str(len(vn))+'maps'+runflg+'_RMMERA5_94yr_lead'+str(leadmjo)+'_dailyinput_mem'+str(nmem)+'d'+str(testyn)+'.csv', autoreg_pred_av, delimiter=",")
        np.savetxt(path_forecasts+'predicted_disstd_MCDO_UNET_'+str(len(vn))+'maps'+runflg+'_RMMERA5_94yr_lead'+str(leadmjo)+'_dailyinput_mem'+str(nmem)+'d'+str(testyn)+'.csv', autoreg_pred_std, delimiter=",")
