...
model_save = '/pscratch/sd/l/linyaoly/Unet4MJO/19variables_MCDO_'+str(ysta)+'to'+str(testyend)+'_filtered_trop_transfer/'
...
print('Model starts')
model_save1 = '/pscratch/sd/l/linyaoly/Unet4MJO/19variables_MCDO_1901to1958_filtered_trop/'
net.load_state_dict(torch.load(model_save1+'MCDO_UNET_'+str(len(vn))+'mapstrop_RMMERA5_1901to1958_lead'+str(leadmjo)+'_dailyinput_dpr'+str(dprconv)+str(dprmlp)+'.pt'))
net.train()
...
net = net.eval()
torch.save(net.state_dict(), model_save+'MCDO_UNET_'+str(len(vn))+'mapstrop_RMMERA5_'+str(ysta)+'to'+str(testyend)+'_lead'+str(leadmjo)+'_dailyinput_dpr'+str(dprconv)+str(dprmlp)+'.pt')
