...
testystat = 1979  # validation starts
...
RMM = xr.DataArray(
        ...
        attrs=dict(
                description='RMM prediction at time+lead'
        ),
)


RMM.to_netcdf(datadir+'predicted_MCDO_UNET_'+str(len(vn))+'mapstrop_RMMERA5_36yr_lead'+str(leadmjo)+'_dailyinput_mem'+str(nmem)+'d.nc')
