...
def load_test_data(Fn,Fnmjo,leadmjo,mem_list,yn):
  ...
  FF4 = FF4.sel(time=slice(str(yn)+'-01-01', str(yn+1)+'-01-31'), latitude=slice(15,-15))

  FF5 = xr.open_mfdataset(Fn[4]) # v200
  FF5 = FF5.sel(time=slice(str(yn)+'-01-01', str(yn+1)+'-01-31'), latitude=slice(15,-15))

  FF6 = xr.open_mfdataset(Fn[5]) # T200
  FF6 = FF6.sel(time=slice(str(yn)+'-01-01', str(yn+1)+'-01-31'), latitude=slice(15,-15))
