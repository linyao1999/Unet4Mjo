...
plt.rcParams.update({'font.size': 20})
plt.show()
plt.savefig('./eval/UNET_'+flg1+'OMI_35yr_dailyinput_'+str(ystat)+'to'+str(yend)+'av.png', bbox_inches='tight', dpi=300, transparent=False)
plt.close()
...
plt.rcParams.update({'font.size': 20})
plt.show()
plt.savefig('./eval/UNET_'+flg1+'OMI_35yr_dailyinput_'+nmem1+'dmem_'+str(ystat)+'to'+str(yend)+'sp.png', bbox_inches='tight', dpi=300, transparent=False)
plt.close()