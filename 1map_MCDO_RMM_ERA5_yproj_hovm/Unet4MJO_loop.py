...
net = net.eval()
torch.save(net.state_dict(), model_save+'predicted_MCDO_UNET_hvmolr_lat'+str(lat_lim)+'_RMMERA5_'+str(m)+'modes_lead'+str(leadmjo)+'_dailyinput_'+str(ysta)+'to'+str(yend)+'_mem'+str(nmem)+'d.pt')
...
ds.to_netcdf(path_forecasts+'predicted_MCDO_UNET_hvmolr_lat'+str(lat_lim)+'_RMMERA5_'+str(m)+'modes_lead'+str(leadmjo)+'_dailyinput_'+str(ysta)+'to'+str(yend)+'_mem'+str(nmem)+'d.nc')
