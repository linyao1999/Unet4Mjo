...
path_forecasts = '/global/homes/l/linyaoly/ERA5/script/Stability-Explanability/6maps_35yrtraining_RMMERA5/output/'
...
Fnmjo = ['/global/homes/l/linyaoly/ERA5/reanalysis/RMMERA5/2017.csv',
          '/global/homes/l/linyaoly/ERA5/reanalysis/RMMERA5/2018.csv']
...
mylist = np.arange(ysta,yend,1)
for k in mylist:
  fileList_trainmjo.append (['/global/homes/l/linyaoly/ERA5/reanalysis/RMMERA5/'+str(k)+'.csv',
                              '/global/homes/l/linyaoly/ERA5/reanalysis/RMMERA5/'+str(k+1)+'.csv']) #changed by lin
...
for testyn in np.arange(testystat,testyend):
        ...
        Fnmjo = ['/global/homes/l/linyaoly/ERA5/reanalysis/RMMERA5/'+str(testyn)+'.csv',
                '/global/homes/l/linyaoly/ERA5/reanalysis/RMMERA5/'+str(testyn+1)+'.csv']
        ...
        np.savetxt(path_forecasts+'predicted_UNET_u200u850olrprepv200T200_RMMERA5_35yr_lead'+str(leadmjo)+'_dailyinput_mem'+str(nmem)+'d'+str(testyn)+'.csv', autoreg_pred, delimiter=",")
        np.savetxt(path_forecasts+'truth_UNET_u200u850olrprepv200T200_RMMERA5_35yr_lead'+str(leadmjo)+'_dailyinput_mem'+str(nmem)+'d'+str(testyn)+'.csv', autoreg_true, delimiter=",")
