...
def load_test_data(Fn,Fnmjo,leadmjo,mem_list,yn):
  ...
  FF1 = FF1.sel(time=slice(str(yn)+'-01-01', str(yn+1)+'-01-31'))

  FF2 = xr.open_dataset(Fn[1]) # u850
  FF2 = FF2.sel(time=slice(str(yn)+'-01-01', str(yn+1)+'-01-31'))

  FF3 = xr.open_dataset(Fn[2]) # olr
  FF3 = FF3.sel(time=slice(str(yn)+'-01-01', str(yn+1)+'-01-31'))

  FF4 = xr.open_mfdataset(Fn[3]) # tcwv
  FF4 = FF4.sel(time=slice(str(yn)+'-01-01', str(yn+1)+'-01-31'))

  FF5 = xr.open_mfdataset(Fn[4]) # v200
  FF5 = FF5.sel(time=slice(str(yn)+'-01-01', str(yn+1)+'-01-31'))

  FF6 = xr.open_mfdataset(Fn[5]) # T200
  FF6 = FF6.sel(time=slice(str(yn)+'-01-01', str(yn+1)+'-01-31'))

  FF7 = xr.open_dataset(Fn[6]) # sst
  FF7 = FF7.sel(time=slice(str(yn)+'-01-01', str(yn+1)+'-01-31'))
  ...
  psi5=np.asarray(FF5['v'])  # v200
  psi6=np.asarray(FF6['t'])  # T200
  ...
  print('shape of psi21: '+str(psi21.shape))
  ...
  print('shape of psi31: '+str(psi31.shape))
  ...
  print('shape of psi41: '+str(psi41.shape))
  ...
  print('shape of psi51: '+str(psi51.shape))
  ...
  print('shape of psi61: '+str(psi61.shape))
  ...
  print('shape of psi71: '+str(psi71.shape))
  ...
  print("memlist: " + str(mem_list[-1]))
  print('shape of psi_test_label: '+str(psi_test_label.shape))
