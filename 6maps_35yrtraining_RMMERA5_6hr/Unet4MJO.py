...
nmem = int(os.environ["memlen"]) * 4 # the number of how many days we want to include into the input maps
...
path_forecasts = '/global/homes/l/linyaoly/ERA5/script/Stability-Explanability/6maps_35yrtraining_RMMERA5_6hr/output/'
...
Fnmjo = ['/global/homes/l/linyaoly/ERA5/reanalysis/RMMERA56hr/2017.csv',
          '/global/homes/l/linyaoly/ERA5/reanalysis/RMMERA56hr/2018.csv']
...
mylist = np.arange(ysta,yend,1)
for k in mylist:
  fileList_trainmjo.append (['/global/homes/l/linyaoly/ERA5/reanalysis/RMMERA56hr/'+str(k)+'.csv',
                              '/global/homes/l/linyaoly/ERA5/reanalysis/RMMERA56hr/'+str(k+1)+'.csv']) #changed by lin
...
for testyn in np.arange(testystat,testyend):
        ...
        Fnmjo = ['/global/homes/l/linyaoly/ERA5/reanalysis/RMMERA56hr/'+str(testyn)+'.csv',
                '/global/homes/l/linyaoly/ERA5/reanalysis/RMMERA56hr/'+str(testyn+1)+'.csv']
        ...
        np.savetxt(path_forecasts+'predicted_UNET_u200u850olrprepv200T200_RMMERA56hr_35yr_lead'+str(leadmjo)+'_dailyinput_mem'+str(int(nmem/4))+'d'+str(testyn)+'.csv', autoreg_pred, delimiter=",")
        np.savetxt(path_forecasts+'truth_UNET_u200u850olrprepv200T200_RMMERA56hr_35yr_lead'+str(leadmjo)+'_dailyinput_mem'+str(int(nmem/4))+'d'+str(testyn)+'.csv', autoreg_true, delimiter=",")
