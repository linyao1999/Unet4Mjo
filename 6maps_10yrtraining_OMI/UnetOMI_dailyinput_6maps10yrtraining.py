...
from data_loaderomi_dailyinput_10yr import load_test_data
from data_loaderomi_dailyinput_10yr import load_train_data
...
trainN = 345
M = 365  
leadmjo = int(os.environ["lead10yr"]) # lead for output (the MJO index)
nmem = int(os.environ["memlen10yr"])  # the number of how many days we want to include into the input maps
...
path_forecasts = '/global/homes/l/linyaoly/ERA5/script/Stability-Explanability/6maps_10yrtraining_OMI/output/'
