...
path_forecasts = '/global/homes/l/linyaoly/ERA5/script/Stability-Explanability/6maps_35yrtraining_OMI/output/'
...
for testyn in np.arange(testystat,testyend):
        ...
        np.savetxt(path_forecasts+'predicted_UNET_u200u850olrprepv200T200_OMI_35yr_lead'+str(leadmjo)+'_dailyinput_mem'+str(nmem)+'d'+str(testyn)+'.csv', autoreg_pred, delimiter=",")
        np.savetxt(path_forecasts+'truth_UNET_u200u850olrprepv200T200_OMI_35yr_lead'+str(leadmjo)+'_dailyinput_mem'+str(nmem)+'d'+str(testyn)+'.csv', autoreg_true, delimiter=",")
