...
model_save = '/pscratch/sd/l/linyaoly/Unet4MJO/1map_MCDO_RMM_raw/'
...
net = net.eval()
torch.save(net.state_dict(), model_save+'predicted_MCDO_UNET_olr'+str(lat_lim)+'deg_RMM_ERA5_lead'+str(leadmjo)+'_dailyinput_raw_nmem'+str(nmem)+'.pt')
...
ds.to_netcdf(path_forecasts+'predicted_MCDO_UNET_olr'+str(lat_lim)+'deg_RMMERA5_raw_lead'+str(leadmjo)+'_dailyinput_'+str(ysta)+'to'+str(yend)+'_mem'+str(nmem)+'d.nc')
