...
ysta = 1901  # training starts
testystat = 1953  # validation starts
...
yend = 1953  # training ends
testyend = 1957  # validation ends
...
Fn1 = datadir+'ERA5.u200GfltG.day.'+str(ysta)+'to'+str(testyend+1)+'.nc'
Fn2 = datadir+'ERA5.u850GfltG.day.'+str(ysta)+'to'+str(testyend+1)+'.nc'
Fn3 = datadir+'ERA5.olrGfltG.day.'+str(ysta)+'to'+str(testyend+1)+'.nc'

Fn4 = datadir+'ERA5.tcwvGfltG.day.'+str(ysta)+'to'+str(testyend+1)+'.nc'
Fn5 = datadir+'ERA5.v200GfltG.day.'+str(ysta)+'to'+str(testyend+1)+'.nc'
Fn6 = datadir+'ERA5.T200GfltG.day.'+str(ysta)+'to'+str(testyend+1)+'.nc'
Fn7 = datadir+'ERA5.prepGfltG.day.'+str(ysta)+'to'+str(testyend+1)+'.nc'

Fn8 = datadir+'ERA5.u500GfltG.day.'+str(ysta)+'to'+str(testyend+1)+'.nc'
Fn9 = datadir+'ERA5.v500GfltG.day.'+str(ysta)+'to'+str(testyend+1)+'.nc'
Fn10 = datadir+'ERA5.v850GfltG.day.'+str(ysta)+'to'+str(testyend+1)+'.nc'
Fn11 = datadir+'ERA5.Z200GfltG.day.'+str(ysta)+'to'+str(testyend+1)+'.nc'
Fn12 = datadir+'ERA5.Z500GfltG.day.'+str(ysta)+'to'+str(testyend+1)+'.nc'
Fn13 = datadir+'ERA5.Z850GfltG.day.'+str(ysta)+'to'+str(testyend+1)+'.nc'
Fn14 = datadir+'ERA5.T500GfltG.day.'+str(ysta)+'to'+str(testyend+1)+'.nc'
Fn15 = datadir+'ERA5.T850GfltG.day.'+str(ysta)+'to'+str(testyend+1)+'.nc'
Fn16 = datadir+'ERA5.q200GfltG.day.'+str(ysta)+'to'+str(testyend+1)+'.nc'
Fn17 = datadir+'ERA5.q500GfltG.day.'+str(ysta)+'to'+str(testyend+1)+'.nc'
Fn18 = datadir+'ERA5.q850GfltG.day.'+str(ysta)+'to'+str(testyend+1)+'.nc'

# always be careful to let sst as the last input variable
Fn19 = datadir+'ERA5.sstGfltGmask0.day.'+str(ysta)+'to'+str(testyend+1)+'.nc'
...
Fnmjo = '/pscratch/sd/l/linyaoly/ERA5/reanalysis/rmm/full/RMM_ERA5_daily_1901to2020_base1979.nc'
### PATHS and FLAGS ###
...
model_save = '/pscratch/sd/l/linyaoly/Unet4MJO/19variables_MCDO_'+str(ysta)+'to'+str(testyend+1)+'_filtered_trop/'
...
# leadmjo = 30 # lead for output (the MJO index)
...
net = net.eval()
torch.save(net.state_dict(), model_save+'predicted_MCDO_UNET_'+str(len(vn))+'mapstrop_RMMERA5_'+str(ysta)+'to'+str(testyend+1)+'_lead'+str(leadmjo)+'_dailyinput.pt')
...
for testyn in np.arange(testystat,testyend):
        ...
        np.savetxt(path_forecasts+'predicted_MCDO_UNET_'+str(len(vn))+'mapstrop_RMMERA5_'+str(ysta)+'to'+str(testyend+1)+'_lead'+str(leadmjo)+'_dailyinput_mem'+str(nmem)+'d'+str(testyn)+'.csv', autoreg_pred, delimiter=",")
        np.savetxt(path_forecasts+'truth_MCDO_UNET_'+str(len(vn))+'mapstrop_RMMERA5_'+str(ysta)+'to'+str(testyend+1)+'_lead'+str(leadmjo)+'_dailyinput_mem'+str(nmem)+'d'+str(testyn)+'.csv', autoreg_true, delimiter=",")
