...
nmapsnorm = 19  # the number of variables need to be normalized
...
Fn19 = datadir+'ERA5.sstGfltG.day.1979to2020.nc'
...
model_save = '/pscratch/sd/l/linyaoly/Unet4MJO/19variables_MCDO_36yr_filtered_trop_new/'
...
#         psi_train_input_Tr_torch, psi_train_label_Tr_torch, trainN = load_train_data(Fn,vn,Fnmjo,leadmjo,mem_list,yn,lat_lim)
...
#     psi_test_input_Tr_torch_norm[:,nmapsnorm*nmem:nmaps*nmem,None,:,:] = psi_test_input_Tr_torch[:,nmapsnorm*nmem:nmaps*nmem,None,:,:]
    ...
    datesta = pd.Timestamp(np.datetime64(str(testyn-1)+'-12-01')) + pd.DateOffset(months=1) 
