...
net.load_state_dict(torch.load(model_save+'predicted_MCDO_UNET_'+str(len(vn))+'mapstrop_ROMIERA5_36yr_lead'+str(leadmjo)+'_dailyinput.pt'))
net.eval()
...
RMMp_dis = xr.DataArray(
        ...
        attrs=dict(
                description='ROMI prediction distribution'
        ),
        name='ROMIp_dis',
)
...
ds.to_netcdf(path_forecasts+'predicted_MCDO_UNET_'+str(len(vn))+'mapstrop_ROMIERA5_36yr_lead'+str(leadmjo)+'_dailyinput_mem'+str(nmem)+'d.nc')
